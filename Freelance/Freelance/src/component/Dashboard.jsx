    ...
    {role === "poster" && (  <div id="poster">
       ...
       <button className="btns" onClick={() => navigate("/PostedTasks")} style={{background:"linear-gradient(135deg,#4B2F78,#684494)", boxShadow:"0 0 20px rgba(160,100,255,0.20)" , border:"1px solid rgba(190,140,255,0.30)" , display:"flex",flexDirection:"column",justifyContent:"center", alignItems:"center" , fontSize:"30px"}}><i class="bi bi-ui-checks"></i>Post Tasks</button>
        ...
        <button  className="btns" onClick={()=> navigate("/Applicantlist")} style={{background:"linear-gradient(135deg,#174A3A,#237052)", boxShadow:"0 0 18px rgba(132,70,255,0.18)" , border:"1px solid rgba(150,90,255,0.25)",display:"flex",flexDirection:"column",justifyContent:"center", alignItems:"center" , fontSize:"30px" }}><i class="bi bi-pass-fill"></i>Applicant List</button>
         ...
         <button  className="btns" onClick={()=> navigate("/Selectedfreelancer")} style={{background:"linear-gradient(135deg,#4A3A18,#70551F)", boxShadow:"0 0 20px rgba(40,200,130,0.20)" , border:"1px solid rgba(60,210,145,0.30)",display:"flex",flexDirection:"column",justifyContent:"center", alignItems:"center" , fontSize:"30px" }}> <i class="bi bi-check-circle-fill"></i>Poster Profile</button>
         </div>
        </div>
    )}
     ...
     {role === "freelancer" && (   <div id="freelancer" >
         ...
         <button  className="btns" onClick={()=> navigate("/Selectedfreelancer")} style={{background:"linear-gradient(135deg,#4A3A18,#70551F)", boxShadow:"0 0 20px rgba(40,200,130,0.20)" , border:"1px solid rgba(60,210,145,0.30)",display:"flex",flexDirection:"column",justifyContent:"center", alignItems:"center" , fontSize:"30px" }}> <i class="bi bi-check-circle-fill"></i>Freelancer Profile</button>
          
          <button  className="btns" onClick={()=> navigate("/ViewTask")} style={{background:"linear-gradient(135deg,#4B2F78,#684494)", boxShadow:"0 0 20px rgba(160,100,255,0.20)" , border:"1px solid rgba(190,140,255,0.30)" , display:"flex",flexDirection:"column",justifyContent:"center", alignItems:"center" , fontSize:"30px"}}> <i class="bi bi-check-circle-fill"></i>Applied Tasks</button>
